...
\begin{table}
\caption{Errors in the approximations of $f'(a)$ from \cref{ex: complex deriv}.}
...
\begin{description}
\item{(i)} Show that $\Im f(a+ih)/h=f'(0)+O(h^2)$ if $h\to0$ with $h$~real.
...
computations performed in standard 64~bit floating-point arithmetic.
